...
<p align="center">
  <a href="https://devtools.at/tools/border-radius"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate CSS border radius code</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/border-radius">Try Online</a> •
...
**[Try CSS Border Radius Generator online at DevTools.at →](https://devtools.at/tools/border-radius)**
...
Generate CSS border radius code. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/border-radius';
